	...
	<div class="span8">
		...
		<div class="widget orange">
			<div class="widget-title">
				<h4>
					<i class="icon-list-ul"></i> Thêm nhóm việc
				</h4>
			...
			<div class="widget-body">
				...
				<form action='<c:url value="/group/add"/>' method="post">
					<div class="row-fluid">
						<div class="span12s">
							<div class="control-group">
								<label class="control-label">Tên nhóm việc</label>
								<div class="controls">
									<input type="text" class="span12" id="groupName" name="groupName">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label">Mô tả</label>
								<div class="controls">
									<input type="text" class="span12" id="description" name="description">
								</div>
							</div>
						</div>
						<div class="span12">
