...
<div class="row-fluid">
	<div class="span12" style="margin-top: 20px;">
		...
		<h1>
			<span class="icon-edit" style="font-size: 80%;"></span>
			<span>${group.groupName}</span>
		</h1>
		<a href='<c:url value="/task/add?groupId=${group.groupId}" />' class="btn btn-success pull-right" >
			<i class="icon-plus icon-white"></i> Thêm đầu việc
		</a>
...
<div class="bs-docs-example">
	<ul class="nav nav-tabs" id="myTab">
		<li class="active">
			<a data-toggle="tab" href="#home">Thống kê công việc</a>
		</li>
		<li class="">
			<a data-toggle="tab" href="#profile">Danh sách công việc</a>
		</li>
	</ul>
	<div class="tab-content" id="myTabContent">
		...
		<div id="profile" class="tab-pane fade">
			<c:forEach items="${groupTasks}" var="groupTask">
				<div class="row-fluid">
					<div class="span12" style="margin-bottom: 10px">
						<!-- BEGIN PAGE TITLE & BREADCRUMB-->
						<h3 style="display: inline-block;">
							<img src="<c:url value="/assets/img/avatar1_small.jpg"/>" alt="">
							<span>${groupTask.account.fullname}</span>
							<c:set var="accountName" value="${groupTask.account.fullname}"/>
						</h3>
					</div>
				</div>
				<div class="row-fluid">
